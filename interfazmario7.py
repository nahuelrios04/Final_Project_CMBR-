...
class RobotUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.btn_config_seq.setMinimumHeight(30)
        ...
        self.btn_seq.setMinimumHeight(35)
    ...
    def on_status(self, s):
        ...
        if "500" in s:
            ...
            if self.is_homing:
                ...
                self.lbl_status.setStyleSheet("background-color: #2196F3; color: white; font-weight: bold; padding: 4px; border: 2px solid #333; font-size: 20px;") # Azul/Celeste para Homing
            else:
                self.lbl_status.setText("MOVING...")
                self.lbl_status.setStyleSheet("background-color: orange; color: white; font-weight: bold; padding: 4px; border: 2px solid #333; font-size: 20px;") # Naranja para PTP
